    ...
    <section className="relative top-0 flex h-[150vh] w-full flex-col items-start justify-center gap-4 py-2">
      ...
      <div className="flex h-[50vh] w-full flex-col justify-start pl-4 pr-10">
        <p>
          ...
          computação ou informática com intuito principal de automatizar
          ...
          governo, com a necessidade de conhecimentos técnicos e organizacionais
          em seu projeto, desenvolvimento e gerenciamento para trazer suporte na
          tomada de decisão e nas estratégias das organizações.
        </p>
        <p>
          Os Sistemas de Informação e as Tecnologias da Informação e Comunicação
          nas organizações destacam-se pelo uso eficiente de recursos oferecendo
          um impacto significativo na produtividade e na competitividade das
          empresas nacionais e internacionais, em um mundo globalizado e
          competitivo.
        </p>
        <p>
        ...
        <p>
          Os conhecimentos adquiridos na formação do Bacharelado em Sistemas de
          informação estão vinculados principalmente as áreas de Ciência da
          Computação, Matemática e Administração. O curso visa uma formação
          sólida na área da computação, com uma grande diversidade de conteúdos
          como:
        </p>
        <br />
        <ul>
