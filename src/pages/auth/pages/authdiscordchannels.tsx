        ...
        <main className="flex h-full w-full flex-col gap-4 pl-10">
          <section className="flex flex-col gap-1">
            ...
            <h3>
              ...
              professores, abaixo estao um canal direto para cada semestre,
              dessa forma ao entrar em um grupo, voce acessara todos os outros
              grupos de cada materia daquele semestre, e assim podera interagir
              com os outros alunos e professores.
            </h3>
          </section>
...
AuthenticatedDiscordChannels.getLayout = function (page: ReactElement) {
  return <Layout>{page}</Layout>;
};
export default AuthenticatedDiscordChannels;
