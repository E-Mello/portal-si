...
const AuthenticatedInformativos: NextPageWithLayout = () => {
      ...
      >
        ...
        >
          <h3>
            ...
            libero nobis id ducimus sed delectus amet voluptate qui labore,
            maxime veritatis omnis quam dignissimos! Assumenda. Lorem ipsum
            dolor, sit amet consectetur adipisicing elit. Numquam voluptatum
            modi officia totam temporibus libero nobis id ducimus sed delectus
            amet voluptate qui labore, maxime veritatis omnis quam dignissimos!
            Assumenda.
          </h3>
          <img
            ref={imageRef}
...
AuthenticatedInformativos.getLayout = function (page: ReactElement) {
  return <Layout>{page}</Layout>;
};
export default AuthenticatedInformativos;
