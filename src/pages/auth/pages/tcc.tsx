              ...
              <div>
                ...
                >
                  ...
                  <span className={`flex text-start  text-xs `}>
                    ...
                    sistema web para a gestão de informações acadêmicas de
                    alunos e professores de uma instituição de ensino superior.
                    O sistema será desenvolvido utilizando a linguagem de
                    programação PHP, o framework Laravel e o banco de dados
                    MySQL. O sistema será composto por um dashboard interativo,
                    que será responsável por apresentar informações sobre o
                    desempenho acadêmico dos alunos e professores, além de
                    informações sobre a instituição de ensino. O sistema também
                    contará com um sistema de login, que será responsável por
                    autenticar os usuários do sistema. O sistema será
                    desenvolvido utilizando a metodologia ágil SCRUM.
                  </span>
...
AuthenticatedTcc.getLayout = function (page: ReactElement) {
  return <Layout>{page}</Layout>;
};
export default AuthenticatedTcc;
