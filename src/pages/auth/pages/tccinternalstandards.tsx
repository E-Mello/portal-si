...
const AuthenticatedTCCInternalStandards: NextPageWithLayout = () => {
  return (
    <ProtectedRoute>
      <section className="relative flex h-full w-[80vw] flex-col items-start justify-center gap-4 py-2">
        <div className="flex flex-col gap-4 pl-4">
          ...
          <p className="text-white">
            Os critérios para se ministrar as disciplinas de Trabalho de
            Conclusão de Curso I e II, bem como a vinculação dos TCCs às linhas
            de pesquisa do curso de Sistemas de Informação, e demais questões
            inerentes ao processo de orientação e desenvolvimento do TCC, serão
            normatizadas por meio de resolução específica a ser proposta pelo
            corpo docente e aprovadas pelo colegiado de curso e demais
...
AuthenticatedTCCInternalStandards.getLayout = function (page: ReactElement) {
  return <Layout>{page}</Layout>;
};
export default AuthenticatedTCCInternalStandards;
