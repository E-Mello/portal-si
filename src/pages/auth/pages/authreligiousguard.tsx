...
const AuthenticatedReligiousGuard: NextPageWithLayout = () => {
  return (
    <ProtectedRoute>
...
AuthenticatedReligiousGuard.getLayout = function (page: ReactElement) {
  return <Layout>{page}</Layout>;
};
export default AuthenticatedReligiousGuard;
