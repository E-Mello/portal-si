...
const AuthenticatedElectiveSubjects: NextPageWithLayout = () => {
  return (
    <ProtectedRoute>
...
AuthenticatedElectiveSubjects.getLayout = function (page: ReactElement) {
  return <Layout>{page}</Layout>;
};
export default AuthenticatedElectiveSubjects;
