...
const AuthenticatedTeachingCenter: NextPageWithLayout = () => {
  return (
    <ProtectedRoute>
...
AuthenticatedTeachingCenter.getLayout = function (page: ReactElement) {
  return <Layout>{page}</Layout>;
};
export default AuthenticatedTeachingCenter;
